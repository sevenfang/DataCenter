...
/**
 * @author WangCongJun
 * Created by WangCongJun on 2018/7/18.
 */
@Repository
@Service(interfaceClass = NewWareHouseDao.class)
public class NewWarehouseDaoImpl implements NewWareHouseDao {
    private static Logger log = LoggerUtil.RDBMS_LOG;
    private static final String ds="new_warehouse";

    private BaseDao iBaseDao;

    public NewWarehouseDaoImpl(BaseDao iBaseDao) {
